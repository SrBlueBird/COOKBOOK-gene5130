...
```{r setup}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("~/Rclass/Week02")) 
```
...
EnhancedVolcano(sigs.df, x='log2FoldChange', y = 'padj', lab = sigs.df$symbol, col=c('turquoise', 'red', 'purple', 'yellow')) + coord_flip()
```
